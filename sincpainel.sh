...
wget https://github.com/MyEagleService/FreeP/raw/main/web/sshplus.zip.001 > /dev/null 2>&1
wget https://github.com/MyEagleService/FreeP/raw/main/web/sshplus.zip.002 > /dev/null 2>&1
wget https://github.com/MyEagleService/FreeP/raw/main/web/sshplus.zip.003 > /dev/null 2>&1
...
clear
wget https://github.com/MyEagleService/FreeP/raw/main/web/sincpainel.zip > /dev/null 2>&1
