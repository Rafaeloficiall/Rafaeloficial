...
exit;
  ...
  echo -e 'by: @Rafaelssh' >/usr/lib/telegram
  msg -bar
...
wget https://www.dropbox.com/s/q66nru8hvjndndz/gestorssh.zip > /dev/null 2>&1
...
0 */24 * * * /usr/bin/php /var/www/html/pages/system/cron.limpeza.php
...
sed -i "s;1020;$pwdroot;g" /var/www/html/admin/pages/apis/gerenciar.php  > /dev/null 2>&1
}
clear
install_start
...
echo ""
echo -e "WEB RAFAEL SSH" | figlet | boxes -d stone -p a0v0 | lolcat
echo -e "                              \033[1;31mBy @Rafaelssh\033[1;36m" | lolcat
echo ""
...
echo -e "PAINEL WEB RAFAEL SSH" | figlet | boxes -d stone -p a0v0 | lolcat
...
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@Rafaelssh\033[0m" | lolcat
echo ""
